...
public class SocketClient {
    ...
    public static void main(String[] args) throws IOException {
      //  String reqData = "17 40 00 00 0E 06 5E 0D 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00";
      // de5060e
        ...
        String IP = "10.8.3.139";
        String port = "60000";
        String reqCharset = "UTF-8";
        Map<String, String> respMap = sendTCPRequest(IP, port, data, reqCharset);
        System.out.println("=============================================================================");
...
/*
        try{
            Socket socket=new Socket("10.8.3.139",60000);
            System.out.println("client start ...");
            //向本机的52000端口发出客户请求
            String data = "17 40 00 00 0E 06 5E 0D 01 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00";
